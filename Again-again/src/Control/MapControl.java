...
public class MapControl {
    ...
    private static Location[][] createLocations(int numRows, int numCol){
          ...
          locations[0][4] = new Location(0, 4, false, " I ", 2, "It appears the vampire was guarding an arrow, but for who?");
          locations[1][0] = new Location(1, 0, false, " I ", 2, "You find an iron sword lying on the ground. Your chances just got better!");
          locations[1][1] = new Location(1, 1, false, " I ", 2, "There's a shield lying on the ground here. Protection at last!");
          ...
          locations[2][1] = new Location(2, 1, false, " I ", 2, "Apparently, some sunlight is peeking through the roof and a green herb has grown here.");
          locations[2][2] = new Location(2, 2, false, " M ", 3, "A lot of webs are covering the place, and eight eyeballs staring right back. Ick!");
          locations[2][3] = new Location(2, 3, false, " I ", 2, "Apparently, some sunlight is peeking through the roof and a green herb has grown here.");
          ...
          locations[3][1] = new Location(3, 1, false, " I ", 2, "You find a broken wall with some fruit in it, surprisingly still ripe");
          ...
          locations[3][4] = new Location(3, 4, false, " T ", 3, "It's a trap!");
          locations[4][0] = new Location(4, 0, false, " T ", 3, "It's a trap!");
          ...
          locations[4][2] = new Location(4, 2, false, " I ", 2, "There is a pedestal that holds up a glass, angel-shaped flask of shining, white water. Extremely useful against the undead!");
